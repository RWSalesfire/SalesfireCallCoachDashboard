...
export async function POST(request: NextRequest) {
  ...
  // Step 2: Analyze calls with Claude
  ...
  // Step 3: Aggregate daily stats and focus
  ...
  const allSucceeded = result.enrich.success && result.analyze.success && result.aggregate.success;
